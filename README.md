...
📊 Dataset / Veri Seti
The dataset contains nearly 54,000 diamonds with 10 features: Veri seti yaklaşık 54.000 elmas ve 10 özellik içermektedir:
...
To run this notebook, you need the following libraries: Bu projeyi çalıştırmak için aşağıdaki kütüphanelere ihtiyacınız vardır:
